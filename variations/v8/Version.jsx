// V8 — Three-column: V6 left header + status chips + vertical nav | center | metadata-only right panel
...
function LeftNavPanel({ current, onChange, activeSub, onSubChange, currentCompany, onCompanyChange }) {
  ...
  return (
    <div style={{ width: '220px', flexShrink: 0, borderRight: '1px solid var(--grey-200)', display: 'flex', flexDirection: 'column', background: 'var(--white)' }}>
      ...
      {/* Company identity + switcher — V6 style */}
...
// ── Right panel — metadata sections only ──────────────────────────────────────

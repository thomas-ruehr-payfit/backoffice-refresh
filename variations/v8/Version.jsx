...
function DeclarationsPage() {
  ...
  return (
    <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
      ...
      {/* Left sidebar */}
      <div style={{ width: '200px', flexShrink: 0, borderRight: '1px solid var(--grey-200)', paddingTop: '12px' }}>
        {DECLARATION_SECTIONS.map(s => (
          <button
            key={s.id}
            ...
            style={{
              ...
              color: activeSection === s.id ? 'var(--accent)' : 'var(--grey-600)',
              background: activeSection === s.id ? '#EBF0FF' : 'none',
              border: 'none', borderLeft: activeSection === s.id ? '2px solid var(--accent)' : '2px solid transparent',
        ...
        {UTILS_TOOLS.map(t => (
          <button
            ...
            style={{
              ...
              color: activeTool === t.id ? 'var(--accent)' : 'var(--grey-600)',
              background: activeTool === t.id ? '#EBF0FF' : 'none',
              border: 'none', borderLeft: activeTool === t.id ? '2px solid var(--accent)' : '2px solid transparent',
              cursor: 'pointer', fontFamily: 'inherit',
            }}
          >
            {t.label}
